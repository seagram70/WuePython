...
#*********************************************************************************
subprocess.call(r'net use z: \\mpzhwsvdfs02\D$ $Nil22pferd /user:mpzhwsvdfs02\vdfsadmin', shell=True)                   #VDFS Produktions Slave Server
...
#*********************************************************************************
subprocess.call(r'net use z: \\mpzhwsvdfs03\D$ $Nil22pferd /user:mpzhwsvdfs03\vdfsadmin', shell=True)                   #VDFS Produktions Slave Server
...
#*********************************************************************************
subprocess.call(r'net use z: \\mpzhwsvdfs04\D$ $Nil22pferd /user:mpzhwsvdfs04\vdfsadmin', shell=True)                   #VDFS Produktions Slave Server
...
#*********************************************************************************
# ***    Drive Map auf VDFS05 und abhohlen der Memory Logs                       *
#*********************************************************************************
